          ...
          <div>
            ...
            <div>
              <p className="justify-text">
                ...
                at{" "}
                <a href="https://github.com/akashgreninja/Doggonation">
                  Github
                </a>
                . Feel free to explore the code, contribute, or use it as a
                reference for your own projects. Doggonation is a comprehensive
                platform that aims to bring dog lovers together. Here, you can
                find a wealth of information about various dog breeds, their
                characteristics, care tips, and more. Whether you're a proud dog
                owner or simply a dog enthusiast, this platform is designed to
                cater to your needs.
              </p>
